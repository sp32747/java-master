...
public class StreamProgrammingQuestions {
	...
	public static void main(String[] args) {
		...
		// the order is not specific , so we can pass linked hash map , to do that we
		...
		Integer secondHighest = Arrays.stream(numArr).boxed().sorted(Comparator.reverseOrder()).skip(1).findFirst()
				.get();
